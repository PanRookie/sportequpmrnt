...
<frameset rows="10%,*" cols="*" frameborder="no" border="0"
	framespacing="0">
	<frame src="${pageContext.request.contextPath}/userTop"  scrolling="No"
		noresize="noresize" title="topFrame" />
	<frameset rows="*" cols="11%,*" frameborder="no" border="0"
		framespacing="0">
		<frame src="${pageContext.request.contextPath}/usercontrol" scrolling="No" noresize="noresize" title="leftFrame" />
